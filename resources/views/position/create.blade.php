        ...
        @endif
            <form method="POST" action="{{ url('position') }}">
                ...
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="position_name" name="position_name" placeholder="Position">
                ...
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="overtime_salary_per_hour" name="overtime_salary_per_hour" placeholder="overtime_salary_per_hour">
